...
<head>
	...
	<div>
	    <a href="http://localhost:8080/beauty-cosmetic-workspace/list" class="navbar-brand"> Product List </a>
	</div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <p class="m-b-40">Take your skincare routine to the next level with Beauty Cosmetic. <br>
            ...
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Beauty Cosmetic</strong></h1>
                            <p class="m-b-40">These ingestibles helped me see better beauty days <br> filled with
            ...
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> Beauty Cosmetic</strong></h1>
                            <p class="m-b-40">The best beauty supplements backed by <br> research and packed with
